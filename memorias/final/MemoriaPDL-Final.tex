...
\begin{itemize}[label={-}, itemsep=0.0em, topsep=0.5em]
    ...
    \item 11:12 $num = num*10^{-cont}$
        ...
        \subitem else gentoken($<$REALCONST, num$>$)
    \item 0:14 Leer
    \item 0:15 Leer
    \item 15:15 Leer
    \item 15:0 Leer
...
\text{FIRST}(\mathit{eof}) ={}& \{\mathit{eof}\} \quad \text{Los tres conjuntos son disjuntos dos a dos: } \checkmark
\end{align*}
\end{minipage}
\end{center}
...
\text{FIRST}(\mathit{else}\ldots) ={}& \{\mathit{else}\} \quad \text{Los tres conjuntos son disjuntos dos a dos: } \checkmark
\end{align*}
...
\text{FIRST}(\mathit{write}\ldots) ={}& \{\mathit{write}\}, \quad \text{FIRST}(\mathit{return}\ldots) = \{\mathit{return}\} \quad \text{Todos disjuntos dos a dos: } \checkmark
\end{align*}
